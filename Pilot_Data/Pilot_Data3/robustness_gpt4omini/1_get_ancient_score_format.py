...
def get_description(idx, rs):
    ...
    data = pd.read_excel('20250321_善行+恶行描述.xlsx', sheet_name=['恶行描述', '善行描述'])
    for k in data:
        n = 0
...
if __name__ == '__main__':
    ...
    open('data_ancient_scores_gpt4omini20240718_40dim_1234_1011_format.json', 'w').write(json.dumps(data, ensure_ascii=False, indent=2))
