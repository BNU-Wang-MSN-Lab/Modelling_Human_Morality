...
embeddings_llm_ancient_1 = get_data('data_ancient_scores_gpt4omini20240718_40dim_1234_1011_1.json')
embeddings_llm_ancient_2 = get_data('data_ancient_scores_gpt4omini20240718_40dim_1234_1011_2.json')
embeddings_llm_ancient_3 = get_data('data_ancient_scores_gpt4omini20240718_40dim_1234_1011_3.json')
...
def pca_correlation(data0=None, data1=None, data_name0='', data_name1=''):
    for k in data0:
        ...
        fig.savefig('pic/4_' + k[:4] + '_' + data_name0 + '_' + data_name1 + '.png', dpi=300)
        

pca_correlation(data0=embeddings_llm_ancient1011, data1=embeddings_llm_ancient_prompt, data_name0='1011', data_name1='prompt')
pca_correlation(data0=embeddings_llm_ancient1011, data1=embeddings_llm_ancient_1, data_name0='1011', data_name1='random1')
pca_correlation(data0=embeddings_llm_ancient1011, data1=embeddings_llm_ancient_2, data_name0='1011', data_name1='random2')
pca_correlation(data0=embeddings_llm_ancient1011, data1=embeddings_llm_ancient_3, data_name0='1011', data_name1='random3')
pca_correlation(data0=embeddings_llm_ancient1011, data1=embeddings_llm_ancient_format, data_name0='1011', data_name1='format')
